export interface MenuItem {
  ...
  price: number;
  category: 'wings' | 'tenders' | 'sauces' | 'salads' | 'drinks' | 'addons' | 'combo';
  imageUrl?: string;
...
export const menuItems: MenuItem[] = [
  ...
  {
    id: 'drink-large',
    nameHe: 'משקה 1.5 ליטר',
    nameEn: '1.5 Liter Drink',
    descriptionHe: 'משקה גדול',
    descriptionEn: 'Large drink',
    price: 15,
    category: 'drinks',
    isAvailable: true,
  },
  {
    ...
    nameHe: 'פחית',
    nameEn: 'Can',
    descriptionHe: 'משקה בקופסה',
    descriptionEn: 'Canned drink',
    price: 10,
    category: 'drinks',
    isAvailable: true,
  },
  ...
  },
  {
    ...
    nameHe: 'קומבו',
    nameEn: 'Combo Meal',
    descriptionHe: 'טנדרס/כנפיים + צ\'יפס + משקה בקופסה + סלט',
