      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8">
          ...
          <div className="text-center md:text-right space-y-2">
            <p className="text-text-primary/70 text-lg md:text-xl font-body font-bold">
              <span className="text-accent-pink">{t("footer.phone")}:</span>{" "}
              058-6230849
            </p>
            <p className="text-text-primary/70 text-lg md:text-xl font-body font-bold">
              <span className="text-accent-pink">{t("footer.hours")}:</span>{" "}
              {t("hero.hoursValue")}
            </p>
            <p className="text-text-primary/70 text-lg md:text-xl font-body font-bold">
              <span className="text-accent-pink">{t("footer.location")}:</span>{" "}
              {t("hero.location")}
            </p>
          </div>
        ...
        <div className="mt-6 pt-6 border-t border-accent-pink/10 text-center text-text-primary/40 text-xs">
          <div className="flex flex-col items-center gap-2">
            <Link
              to="/privacy"
              className="text-text-primary/60 hover:text-accent-pink transition-colors underline underline-offset-4"
            >
